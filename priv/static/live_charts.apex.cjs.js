...
var live_charts_apex_exports = {};
__export(live_charts_apex_exports, {
  default: () => live_charts_apex_default
});
module.exports = __toCommonJS(live_charts_apex_exports);
...
var ApexChartsHook = {
   ...
   */
  renderChart() {
    this.chart = new us(this.el, this.getConfig());
    this.chart.render();
  },
  /**
...
apexcharts/dist/apexcharts.esm.js:
  ...
  *)
*/
//# sourceMappingURL=live_charts.apex.cjs.js.map
